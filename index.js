...
const PremiumUserIds = [716505457, 1806425695, 826978407,808597264,6836917211];
...
var hostURL = "https://a8596851-afff-419d-9be7-35fe1dbb2799-00-gdxm5rr83ykh.riker.replit.dev";
...
Our Pricings:
===========================================
 * Per Week 1549 INR (Offer Price 1049).
    - 8 Tries
    - 1 User
    - User add on @ 249
    
  * Monthly 3499 INR (Offer Price 2999).
    - 30 Tries
    - 2 User
    - User add on @ 199    
...
\nUse /help to know about working...`,
        m
      );
      bot.sendMessage(
        targetChatId,
